...
describe("8 Guest Wrangler fr-fr", function () {
    it("should be able to buy item", function () {
        let site = '/s/Wrangler/fr-fr'
        browser.setWindowSize(1200, 1200)
        productDetailsPage.open(site + "/shop/homme/jeans-et-vetements/jeans/texas-low-stretch-in-black-overdye-W12109004.html");
